...
DB_PRODUCTS.push({ uuid: "1", name: "Hamburguesa c/fritas", description: "Hamburguesa con papas fritas", price: 35000 });
DB_PRODUCTS.push({ uuid: "2", name: "Milanesa c/pure", description: "Un plato de milanesa con pure", price: 50000 });
DB_PRODUCTS.push({ uuid: "3", name: "Fideos c/salsa", description: "Un plato de fideos con salsa", price: 25000 });
DB_PRODUCTS.push({ uuid: "4", name: "Una Coca", description: "Botella de Coca-Cola", price: 15000 });
